...
public class BraSizeTypeAdapter extends RecyclerView.Adapter<BraSizeTypeAdapter.MyViewHolder> {
    ...
    public BraSizeTypeAdapter(List<BrandModel> brandModels, Activity activity, BraSizeTypeAdapter.onItemClickListener onItemClickListener) {
    ...
    @Override
    public BraSizeTypeAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_brand_suggession, parent, false);

        return new BraSizeTypeAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final BraSizeTypeAdapter.MyViewHolder holder, final int position) {
