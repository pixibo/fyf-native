...
public class BrandCategoryModelAdapter extends RecyclerView.Adapter<BrandCategoryModelAdapter.MyViewHolder> {
    ...
    public BrandCategoryModelAdapter(List<BrandModel> brandModels, Activity activity, onItemClickListener onItemClickListener) {
