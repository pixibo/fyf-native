...
public class PUT_TOKEN extends AsyncTask<String, Void, String> {
    ...
    public PUT_TOKEN(Context context, String url, JSONObject formBody, Utils.TYPE Servicetype, Result resultListener,String token) {
