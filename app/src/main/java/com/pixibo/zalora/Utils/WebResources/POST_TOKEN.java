...
public class POST_TOKEN extends AsyncTask<String, Void, String> {
    ...
    public POST_TOKEN(Context context, String url, JSONObject formBody, Utils.TYPE Servicetype, Result resultListener,String token) {
        Log.e("URLS ",Servicetype+" "+url);
        Log.e("formBody ",Servicetype+" "+formBody);
    ...
    protected void onPostExecute(String s) {
        ...
        Log.e("POST_TOKEN", "Response : "+responseCode+" Request= " + Servicetype + " Response = " + s);
