...
public class GET_TOKEN extends AsyncTask<String, Void, String> {
    ...
    public GET_TOKEN(Context context, String url, Utils.TYPE Servicetype, Result resultListener,String token) {
    ...
    protected void onPostExecute(String s) {
        ...
        Log.e("GET_TOKEN", "Response : "+responseCode+" Request= " + Servicetype + " Response = " + s);
